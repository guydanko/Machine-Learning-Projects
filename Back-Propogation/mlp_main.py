...
def get_args():
    ...
    parser.add_argument('-m', '--mode', type=str, choices=['single', 'series'], default= 'series',
    ...
    parser.add_argument('-hl', '--hidden_layers', nargs='+', type=int, default=(5,-1,10,10,-1,15,15,15,-1,30,30,30,30,-1,50,50,50,50,50),
    ...
    parser.add_argument('-o', '--output_name', type=str, default="figure_b",
